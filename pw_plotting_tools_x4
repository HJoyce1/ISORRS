...
def results_plot(z,z_ext,radius,num_ion,e_charge,E,ion_dict,electron_dict,ac,ag,e_flux,ion_flux):
    ...
    pl.plot(z/1000,((e_charge/ion_dict[1]["mass"])*(E*4)),linestyle= '-',color=[0,0.2,0.5])
    pl.plot(z/1000,((e_charge/ion_dict[2]["mass"])*(E*4)),linestyle= '-',color=[0.2,0.6,1])
    ...
    pl.grid('on') 
    ax4 = ax3.twiny()
    ax4.plot(z/radius,(e_charge/ion_dict[1]["mass"])*(E*4),linestyle='-',color=[0,0.2,0.5])
