...
#     cross sectional area A
    ...
    n_H3_plus[2:-2,0] = 5*10**10*np.exp(-(z/(H_scale*((m_H_plus/m_H3_plus)*(b_temp/3000))))) + n_H3_plus_floor #1*10**10 (subauroral, run 1) #5*10**10 (auroral) #1*10**9 (nonauroral)
    n_H3_plus[0:2,0]=5*10**10*np.exp(-(gb_z/(H_scale*((m_H_plus/m_H3_plus)*(b_temp/3000))))) + n_H3_plus_floor
    n_H3_plus[-2:,0]=5*10**10*np.exp(-(ge_z/(H_scale*((m_H_plus/m_H3_plus)*(b_temp/3000))))) + n_H3_plus_floor
    rho_H3_plus[2:-2,0] = n_H3_plus[2:-2,0] * m_H3_plus
    rho_H3_plus[0:2,0]=n_H3_plus[0:2,0] * m_H3_plus
    rho_H3_plus[-2:,0]=n_H3_plus[-2:,0] * m_H3_plus
